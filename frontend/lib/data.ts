...
,
  {
    ...
    placementRate: 93,
    avgPackage: 55000,
    description: "Kyoto University is a public research university located in Kyoto, Japan. Established in 1897, it is the second oldest Japanese university and is famous for its research-focused culture.",
    courses: [
      { name: "B.Sc. in Computer Science", duration: "4 Years", fees: 25000 },
      { name: "M.Sc. in Engineering Science", duration: "2 Years", fees: 27000 }
    ],
    reviews: [
      {
        userName: "Yuki Tanaka",
        rating: 5,
        comment: "Incredible academic freedom and excellent scientific research groups.",
        date: "2026-04-15"
      }
    ],
    amenities: ["Research Labs", "High-Performance Computing", "Historic Campus", "Japanese Language Center"],
    rank: 56,
  ...
  },
  {
    ...
    placementRate: 92,
    avgPackage: 48000,
    description: "Seoul National University is a national research university located in Seoul, South Korea. Founded in 1946, it is widely considered the most prestigious university in South Korea.",
    courses: [
      { name: "B.S. in Computer Science & Engineering", duration: "4 Years", fees: 24000 },
      { name: "B.A. in Business Administration", duration: "4 Years", fees: 23000 }
    ],
    reviews: [
      {
        userName: "Min-jun Kim",
        rating: 5,
        comment: "Top university in Korea. The campus is surrounded by mountains, very scenic and great for studying.",
        date: "2026-03-10"
      }
    ],
    amenities: ["Gwanak Mountain Views", "Central Library", "Language Education Institute", "Dormitory Housing"],
    rank: 57,
  ...
  },
  {
    ...
    placementRate: 96,
    avgPackage: 24000,
    description: "IIT Bombay is a public research university located in Powai, Mumbai, India. Established in 1958, it is a premier institute of national importance and highly competitive to get into.",
    courses: [
      { name: "B.Tech. in Computer Science & Engineering", duration: "4 Years", fees: 12000 },
      { name: "B.Tech. in Electrical Engineering", duration: "4 Years", fees: 12000 }
    ],
    reviews: [
      {
        userName: "Aditya Sharma",
        rating: 5,
        comment: "The campus life at Powai Lake is amazing. Competitive coding environment and placements are exceptional.",
        date: "2026-04-18"
      }
    ],
    amenities: ["Powai Lake Access", "IITB Innovation Hub", "H1 Central Library", "Hostel Accommodation"],
    rank: 58,
  ...
  },
  {
    ...
    placementRate: 95,
    avgPackage: 22000,
    description: "Indian Institute of Technology Delhi is a public technical and research university located in New Delhi, India. It is one of the oldest IITs and is known for its strong academic curriculum and research output.",
    courses: [
      { name: "B.Tech. in Computer Science", duration: "4 Years", fees: 12000 },
      { name: "B.Tech. in Mechanical Engineering", duration: "4 Years", fees: 12000 }
    ],
    reviews: [
      {
        userName: "Rohan Gupta",
        rating: 5,
        comment: "Excellent campus in South Delhi. Very high placement rates and great startup culture among seniors.",
        date: "2026-03-24"
      }
    ],
    amenities: ["South Delhi Campus", "Supercomputing Lab", "Students Activity Center", "Academic Blocks"],
    rank: 59,
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1564981797816-1043664bf78d?q=80&w=150&h=150&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1564981797816-1043664bf78d?q=80&w=1200",
    ...
    placementRate: 94,
    avgPackage: 18000,
    description: "BITS Pilani is a private deemed university in Pilani, Rajasthan, India. It focuses primarily on higher education in engineering and sciences and has a unique 'zero attendance policy'.",
    courses: [
      { name: "B.E. in Computer Science", duration: "4 Years", fees: 26000 },
      { name: "B.E. in Mechanical Engineering", duration: "4 Years", fees: 26000 }
    ],
    reviews: [
      {
        userName: "Srinivas Rao",
        rating: 5,
        comment: "Zero attendance policy is amazing for self-study and startup incubation. Practice school program gives industry exposure.",
        date: "2026-05-01"
      }
    ],
    amenities: ["Zero Attendance Policy", "Practice School Program", "BITS Pilani Library", "Startup Incubator"],
    rank: 60,
  ...
  },
  {
    ...
    placementRate: 90,
    avgPackage: 12000,
    description: "Vellore Institute of Technology is a private deemed university located in Vellore, Tamil Nadu, India. Founded in 1984 as Vellore Engineering College, the institute offers 66 undergraduate programs.",
    courses: [
      { name: "B.Tech. in Computer Science", duration: "4 Years", fees: 21000 },
      { name: "B.Tech. in Information Technology", duration: "4 Years", fees: 21000 }
    ],
    reviews: [
      {
        userName: "Priya Nair",
        rating: 4,
        comment: "Massive campus with strict rules, but highly active coding clubs and exceptional placement numbers.",
        date: "2026-04-12"
      }
    ],
    amenities: ["State-of-the-art Labs", "Gym & Sports Center", "Hostel Facilities", "Food Courts"],
    rank: 61,
